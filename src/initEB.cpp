...
void
initializeEB (const Geometry& geom, int required_coarsening_level,
                int max_coarsening_level)
{
    ...
    if (geom_type == "combustor")
    {
        ...
        std::cout << "Generating EB for sphere geometry";
        Real radius = 0.25;
        Vector<Real> center = {AMREX_D_DECL(0.,0.,0.)};
        EB2::SphereIF sphere(radius,
                             {AMREX_D_DECL(center[0],center[1],center[2])},
                             false);
